...
export default function Error({
  ...
  return (
    <div className="min-h-screen w-screen flex flex-col bg-[#21A4F2] justify-center items-center overflow-scroll overflow-x-hidden">
      ...
      <div className="h-[1728px] w-full relative flex flex-col items-center gap-6">
        ...
        <div className="flex flex-col gap-2">
          ...
          <ButtonThog
            href="https://t.me/TheoryOfGravity"
            text="TLGRM"
            className={karmaticArcade.className}
          />
          <ButtonThog
        ...
        <Image
          src="/images/thoggame/section1.png"
      ...
      <div className="w-full bg-[#653C20] relative flex flex-col items-center gap-12 py-20">
        ...
        <p
          className={`text-[25px] lg:text-[30px] text-[#E84524] flex gap-2 items-center ${karmaticArcade.className}`}
        >
